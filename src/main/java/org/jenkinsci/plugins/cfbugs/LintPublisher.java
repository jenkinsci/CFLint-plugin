...
public class LintPublisher extends HealthAwarePublisher {
    ...
    private static final String PLUGIN_NAME = "cfbugs";

    /** Default filename pattern. */
    private static final String DEFAULT_PATTERN = "**/cfbugs-results.xml";
    ...
    public BuildResult perform(final AbstractBuild<?, ?> build, final PluginLogger logger)
        ...
        logger.log(Messages.CFBugs_Publisher_CollectingFiles());
    ...
    @Override
    public CFBugsDescriptor getDescriptor() {
        return (CFBugsDescriptor) super.getDescriptor();
    }
