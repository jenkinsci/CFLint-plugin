...
public final class CFBugsDescriptor extends PluginDescriptor {

    /** Used in visible URLs. */
    public static final String PLUGIN_NAME = "cfBugs";

    /** Used to specify location of resources. */
    public static final String PLUGIN_ROOT = "/plugin/cfbugs/";

    /** Icon to use for the result and project action. */
    private static final String ACTION_ICON = PLUGIN_ROOT + "icons/CFBugs24x24.png";

    public CFBugsDescriptor() {
        super(LintPublisher.class);
    }

    @Override
    public String getDisplayName() {
        return Messages.CFBugs_Publisher_Name();
    }
