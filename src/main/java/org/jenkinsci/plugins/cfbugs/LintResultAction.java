...
public class LintResultAction extends AbstractResultAction<LintResult> {
    ...
    public String getDisplayName() {
        return Messages.CFBugs_DisplayName();
    }

    @Override
    protected PluginDescriptor getDescriptor() {
        return new CFBugsDescriptor();
    }

    @Override
    public String getMultipleItemsTooltip(final int numberOfItems) {
        return Messages.CFBugs_ResultAction_Tooltip_Multiple(numberOfItems);
    }

    @Override
    public String getSingleItemTooltip() {
        return Messages.CFBugs_ResultAction_Tooltip_Single();
    }
